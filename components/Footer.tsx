  ...
  return (
    <footer className="mt-auto border-t border-slate-200 bg-white">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-slate-400 sm:flex-row sm:px-6">
        <span>© {new Date().getFullYear()} Successifier. All rights reserved.</span>
        <nav className="flex gap-4">
          <Link href="/c/legal/terms" className="hover:text-slate-700">Terms</Link>
          <Link href="/c/legal/privacy" className="hover:text-slate-700">Privacy</Link>
