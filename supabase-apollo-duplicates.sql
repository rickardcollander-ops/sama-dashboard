-- Cross-campaign duplicate detection for the TM portal.
--
-- Run this after supabase-apollo-campaigns.sql.
-- Adds a domain index for fast cross-campaign lookups and a function that
-- returns leads for a campaign enriched with prior_campaigns — a JSON array
-- of every other campaign where the same domain appears.
